...
void usage(std::ostream&o){o<<"usage: yllama-runner --model PATH --ctx N --threads N [--gpu-layers N]\n       yllama-runner --version | --build-info\n";}
...
int main(int argc,char**argv){
  ...
  return yllama::run_stdio(std::cin,std::cout,std::cerr,c);
}
